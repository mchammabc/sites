...
/** 
  ...
  * AngularJS Directive
*/
angular.module('core').controller('MapCoordinatesCtrl', ["$scope", "$compile", function ($scope, $compile) {
    var TILE_SIZE = 256;
...
angular.module('core').controller('EventSimpleCtrl', ['$scope', '$timeout',
...
angular.module('core').controller('EventPropertiesCtrl', ["$scope", function ($scope) {
...
angular.module('core').controller('ControlCustomStateCtrl', ["$scope", function ($scope) {
