...
angular.module('core').controller('VisitsCtrl', ["$scope", function ($scope) {
...
angular.module('core').controller('SalesCtrl', ["$scope", function ($scope) {
...
angular.module('core').controller('OnotherCtrl', ["$scope", function ($scope) {
...
angular.module('core').controller('LastCtrl', ["$scope", function ($scope) {
